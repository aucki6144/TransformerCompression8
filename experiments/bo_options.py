def lora_target_map(model: str):
    match model:
        ...
        case 'meta-llama/Llama-2-7b-hf' | 'meta-llama/Llama-2-13b-hf' | 'meta-llama/Llama-2-70b-hf' | 'meta-llama/Meta-Llama-3-8B' | 'meta-llama/Meta-Llama-3-8B-Instruct' | 'meta-llama/Meta-Llama-3-70B' | 'meta-llama/Meta-Llama-3-70B-Instruct' | 'meta-llama/Llama-3.2-1B' | 'meta-llama/Llama-3.2-3B':
            return {
                'qkv_proj': ['k_proj', 'q_proj', 'v_proj'],
